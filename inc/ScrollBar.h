...
public:
    ...
    ): Button(width, height, !Button::STICKY, onClickFunction, nullptr, parent),
...
public:
        ...
        Container(width, height, parent), isHorizontal_(isHorizontal), onScroll_(onScroll)
    {
        ...
        topButton_ = new Button(buttonSize_.x, buttonSize_.y, !Button::STICKY, 
            [this] { move(THUMB_MOVING_DELTA); }, nullptr, this);
        addWidget(( isHorizontal ? rect_.w - buttonSize_.x : 0), (!isHorizontal ? rect_.h - buttonSize_.y : 0), topButton_);

        bottomButton_ = new Button(buttonSize_.x, buttonSize_.y, !Button::STICKY,
            [this] { move(-THUMB_MOVING_DELTA); }, nullptr, this);
